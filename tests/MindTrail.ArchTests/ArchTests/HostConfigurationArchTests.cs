...
public class HostConfigurationArchTests
{
    ...
    /// <summary>
    /// Tests to check the dependency policy for <see cref="MindTrail.HostConfiguration"/> component.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests to check class naming of <see cref="MindTrail.HostConfiguration"/> component.
    /// </summary>
    [Fact]
