...
public static class ServiceCollectionDecoratorExtensions
{
    ...
    /// <typeparam name="TImplementation">The type of the innermost, undecorated implementation of <typeparamref name="TService"/>.</typeparam>
    /// <typeparam name="TDecorator">The type of the decorator wrapping <typeparamref name="TImplementation"/>.</typeparam>
    /// <param name="services">The service collection used to register the service and its decorator.</param>
