...
public static class EfCoreMssqlConfig
{
    ...
    public static void AddEfCoreMssqlConfig<TContext>(this IServiceCollection services,
        IConfiguration configuration, IStartupLogger logger = null) where TContext : DbContext
    {
    ...
    public static async Task ApplyMssqlMigrationAsync<TContext>(this IHost host, IStartupLogger logger = null)
