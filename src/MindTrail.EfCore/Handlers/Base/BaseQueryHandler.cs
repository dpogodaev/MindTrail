...
public abstract class BaseQueryHandler(AppDbContext dbContext)
{
    ...
    /// <param name="maxPageSize">The maximum allowed page size, regardless of <paramref name="paginationModel"/>. Optional.</param>
    ...
    /// The <see cref="PaginationModel.PageNumber"/> or <see cref="PaginationModel.PageSize"/> is zero.
    /// </exception>
